...
void init() async {
  ...
  final buffer0 = (() {
    ...
    // Uint32List(buffer.getMappedRange())[0] = 0;
    // buffer.unmap();
    return buffer;
  })();
  ...
  final buffer1 = (() {
    ...
    // Uint32List(buffer.getMappedRange())[0] = 1;
    // buffer.unmap();
    return buffer;
  })();
  ...
  // ERROR: errors.dart:296 Uncaught (in promise) DartError: TypeError: Record (buffer: Instance of 'LegacyJavaScriptObject'): type '({LegacyJavaScriptObject buffer})' is not a subtype of type 'JSObject'
  // NEED FIX: GPUBindingResource
  //https://github.com/dart-lang/sdk/issues/55256
  //https://github.com/dart-lang/sdk/issues/55465
  ...
  void updateSettings() {
    ...
    device.queue.writeBuffer(
      blurParamsBuffer,
      0,
      [settings.filterSize, blockDim] as JSObject,
    );
  }
  ...
  void frame() {
    ...
    final passEncoder = commandEncoder.beginRenderPass(GPURenderPassDescriptor(
      colorAttachments: [
        GPURenderPassColorAttachment(
          ...
          clearValue: [0, 0, 0, 1] as JSObject,
          loadOp: 'clear',
          storeOp: 'store',
        ),
    ...
    window.requestAnimationFrame(frame as JSFunction);
  }
  window.requestAnimationFrame(frame as JSFunction);
}
