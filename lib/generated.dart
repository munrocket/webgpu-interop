...
import 'package:web/web.dart' show DOMException, EventTarget, Event, EventInit, EventHandler, Navigator;
...
///
/// > [!NOTE]
/// > To use timestamp queries, the `timestamp-query` [GPUSupportedFeatures]
/// > must be enabled in the [GPUDevice].
///
